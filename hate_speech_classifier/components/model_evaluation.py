...
from hate_speech_classifier.entity.artifact_entity import (ModelEvaluationArtifacts,
...
class ModelEvaluation:
    ...
    def get_best_model_from_gcloud(self) -> str:
        ...
        try:
            ...
            if Path(self.model_evaluation_config.BUCKET_NAME, self.model_evaluation_config.MODEL_NAME).exists():
    ...
    def evaluate(self):
        ...
        try:
            ...
            loaded_model = load_model(self.model_trainer_artifacts.trained_model_path)
